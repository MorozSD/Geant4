...
void TrackingAction::Abs(G4double dk) {
  fE = dk;
}
...
// Collect energy and track length step by step
 ...
 fTrackingAction->Abs(edep);
  ...
  G4cout << "Time of interaction = "<<G4BestUnit(time,"Time")<< G4endl; //<< time << G4endl;//<<G4BestUnit(time,"Time")<< G4endl;
  //<< fE << G4endl; 
  };
 }
