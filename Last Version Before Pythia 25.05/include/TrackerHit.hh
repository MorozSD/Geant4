...
{
  public:
   // TrackerHit(EventAction* eventAction);
    TrackerHit();
   ...
   /* void SetAddWarning (G4int Warn, G4int Norm) {fw += dnw; fn += dnn; };*/
   ...
   /* G4int GetAddWarning() const {return fw;};
    G4int GetAddNorm() const {return fn;};*/
