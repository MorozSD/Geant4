...
#ifndef userPrimaryGeneratorEventAction_h
#define userPrimaryGeneratorEventAction_h 1
...
class EventAction : public G4UserEventAction
{
  public:
    ...
    void AddMaterial (G4int numberAir, G4int numberGas, G4int numberPET) { fNumAIR += numberAir, fNumGAS += numberGas, fNumPET += numberPET; };
   ...
   /* void AddAbs(G4double de);
    ...
    void AddMaterial (G4double number) { fNumV += number; }
