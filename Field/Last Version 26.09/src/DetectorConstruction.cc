...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
 ...
 // Gamma detector Parameters
  //
 // G4double cryst_r = 4.9*mm, cryst_x = 236*cm;
 G4double cryst_r = 4.9*mm, cryst_x = 54*cm;
 // G4double cryst_r = 5*mm, cryst_x = 54*cm;
  G4int num_rings = 10;
  // !!!!!!!! it must be: num_rings = 64, ring_R1=250mm, cryst_r = 4.9*mm
  G4int nbn_cryst = 400;
  G4double ring_R1 = 250*mm;
  //G4double ring_R1 = 0*mm;
...
G4Tubs* solidPET =
  ...
  G4int copyN = 0;     
 //Gas                
// G4double r_Gas = 0.05*mm, R_Gas = r_PET ;
