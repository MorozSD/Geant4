...
RunAction::RunAction()
{
 ...
 // G4RunManager::GetRunManager()->SetPrintProgress(1000);
  ...
  analysisManager->CreateH1("Start Time","Timing distribution", 150, -10.*ns, 2000.*ns);
 ...
 //  analysisManager->CreateH1("Length","Parent's ID", 100, -1., 1000.);
  analysisManager->CreateH1("Time3","Timing distribution no drift", 150, -10.*ns, 2000.*ns);
//  analysisManager->CreateH1("Time4","Timing distribution with drift", 100, -1.*ns, 1200.*ns);
   analysisManager->CreateH1("Z0","Z", 100, 0., 20.*cm);
